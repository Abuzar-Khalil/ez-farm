...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('ezdairy', '0002_alter_lactation_options_alter_milkproduction_options_and_more'),
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('time_of_day', models.CharField(choices=[('morning', 'Morning'), ('afternoon', 'Afternoon'), ('evening', 'Evening'), ('other', 'Other')], default='morning', max_length=20, verbose_name='time of day')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('created_at', models.DateTimeField(auto_now_add=True, verbose_name='created at')),
                ('updated_at', models.DateTimeField(auto_now=True, verbose_name='updated at')),
                ('dairy_animal', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='health_records', to='ezdairy.dairyanimal', verbose_name='dairy animal')),
                ('meat_animal', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='health_records', to='ezmeat.meatanimal', verbose_name='meat animal')),
            ],
            options={
